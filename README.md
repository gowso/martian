...
Martian Proxy can be installed using `go install`
    ...
    go get github.com/gowso/martian/ && \
    go install github.com/gowso/martian/cmd/proxy
...
modifier](https://github.com/gowso/martian/wiki/Modifier-Reference#logging) is
...
* `[package.Type]`: The package.Type of the modifier that you want to use. In
  ...
  refer to the [modifier reference](https://github.com/gowso/martian/wiki/Modifier-Reference)).
...
[`martian.go`](https://github.com/gowso/martian/blob/master/martian.go)).
